      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle max-w-3xl mx-auto">
            Makati City has one of the highest concentrations of registered vehicles in Metro Manila, 
            yet automotive repair services remain informal, opaque, and inconsistent
          </p>
        </div>

        {/* Problem Cards */}
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {/* Vehicle Owners Problems */}
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-red-100">
            ...
            <ul className="space-y-4">
              {problems.customers.map((problem, index) => (
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-orange-100">
            ...
            <ul className="space-y-4">
              {problems.mechanics.map((problem, index) => (
                <li key={index} className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  Although Makati supports livelihood initiatives, skilled informal trades remain digitally disconnected 
                  from secure demand systems. Nationally, informal labor remains a major challenge — automotive mechanics, 
                  welders, and technical workers often operate outside structured digital ecosystems.
                </p>
                <p className="text-gray-300 leading-relaxed">
                  <span className="font-bold text-white">Without civic-tech intervention</span>, informal service markets 
                  will continue limiting income stability and consumer trust.
                </p>
              </div>
            </div>
          </div>
